                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-toolbar">
                            <!-- BEGIN THEME PANEL -->
                            <div class="btn-group">
                                <button id="sample_editable_1_new" class="btn sbold green">TAMBAH DATA
                                    <i class="fa fa-plus"></i>
                                </button>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                        ...
                                        <tbody>
                                            <tr>   
                                                <td>1</td>
                                                <td>20162</td>
                                                <td>Semester Genap 2016/2017</td>
                                                <td>2016/2017</td>
                                                <td>Ya</td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                <a href="javascript:;">
                                                                    <i class="icon-docs"></i> Lihat </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;">
                                                                    <i class="icon-tag"></i> Ubah </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;">
...
<![endif]-->
        ...
        <script src="pages/scripts/table-datatables-responsive.min.js" type="text/javascript"></script>
