                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="tools">
                                    <div class="btn-group">
                                    <a href="<?php echo base_url();?>opd/Pengaduan/create" class="btn sbold btn-primary"><i class="fa fa-plus"></i> Create Pengaduan
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="buku">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>   
                                                ...
                                                <td><a href="<?php echo base_url(); ?>opd/pengaduan/edit/<?php echo $row->pengaduan_id; ?>" class="btn btn-success">Manage</a> <a href="<?php echo base_url(); ?>opd/Pengaduan/delete/<?php echo $row->pengaduan_id; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
                                            </tr>
                                            <?php  } ?>
                                        </tbody>
                                    </table>
