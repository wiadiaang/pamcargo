                        ...
                        <div class="col-md-12">
                            <div class="portlet light bordered">
                                ...
                                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" >
                                    ...
                                    ?>
                                    <input type="hidden" class="form-control" name="city_id" id="city_id" value="<?php echo $city_id; ?>" />
                                    <div class="row">
                                        <div class="col-md-">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="prop" id="prop" required="true" <?php echo $read_only?>>
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <label class="col-md-4 control-label" for="nama_siswa">K BSNI</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" name="k_bsni" id="k_bsni" value="<?php echo $k_bsni; ?>" <?php echo $read_only?>/>
                                                        <input type="hidden" class="form-control" name="k_bsni_old" id="k_bsni_old" value="<?php echo $k_bsni; ?>" <?php echo $read_only?>/>
                                                        <div class="form-control-focus"></div><?php echo form_error('k_bsni') ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
