                        ...
                        <div class="col-md-12">
                            <div class="portlet light bordered">
                                ...
                                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" >
                                    ...
                                    ?>
                                    <input type="hidden" class="form-control" name="courier_id" id="courier_id" value="<?php echo $courier_id; ?>" />
                                    <div class="row">
                                        <div class="col-md-">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="prop" id="prop" onchange="ajaxkota(this.value)" required="true" <?php echo $read_only?>>
                                                            ...
                                                            ?>
                                                            <option <?php echo $courier_province_id== $cl->province_id ? 'selected="selected"' : '' ?> value="<?php echo $cl->province_id  ?>"><?php echo $cl->name  ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                        </select>
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="kota" id="kota" required="true" onchange="ajaxkec(this.value)" <?php echo $read_only?>>
                                                            <?php
                                                                if($courier_city_id != NULL){
                                                                    $city = $this->db->query("select name from city where city_id = '" . $courier_city_id . "'")->row();

                                                            ?>
                                                                <option value="<?php echo $courier_city_id?>"><?php echo $city->name?></option>
                                                            <?php
                                                                }else{
                                                            ?>
                                                                <option value="">-<?php echo $this->lang->line('selection'); ?>-</option>
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="kec" id="kec" class="form-control" onchange="ajaxkel(this.value)" <?php echo $read_only?>>
                                                            <?php
                                                                if($courier_district_id != NULL){
                                                                    $district = $this->db->query("select name from district where district_id = '" . $courier_district_id . "'")->row();

                                                            ?>
                                                                <option value="<?php echo $courier_district_id?>"><?php echo $district->name?></option>
                                                            <?php
                                                                }else{
                                                            ?>
                                                                <option value="">-<?php echo $this->lang->line('selection'); ?>-</option>
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <label class="control-label col-md-4" for="PersonalContactDetails_Address_Company">Village</label>
                                                    <div class="col-md-8 ">
                                                        <select name="kel" class="form-control" id="kel" onchange="showCoordinate();" <?php echo $read_only?>>
                                                        <?php
                                                                if($courier_village_id != NULL){
                                                                    $village = $this->db->query("select name from village where village_id = '" . $courier_village_id . "'")->row();

                                                            ?>
                                                                <option value="<?php echo $courier_village_id?>"><?php echo $village->name?></option>
                                                            <?php
                                                                }else{
                                                            ?>
                                                                <option value="">-<?php echo $this->lang->line('selection'); ?>-</option>
