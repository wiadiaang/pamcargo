                                                        ...
                                                        <div class="col-md-">
                                                            <div class="form-body">
                                                                <div class="form-group form-md-line-input">
                                                                    <label class="col-md-4 control-label" for="nama_siswa">NAME OPD</label>
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" name="nama_opd" value="<?php echo $nama_opd; ?>" />
                                                                        <div class="form-control-focus"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group form-md-line-input">
                                                                    <label class="col-md-4 control-label" for="nama_siswa">Alias</label>
                                                                    <div class="col-md-8">
