			...
			<div class="col-md-12">
				...
				<div class="portlet light bordered">
					<div class="portlet-title">
						...
						<div class="tools">
						<div class="btn-group">
								<a href="<?php echo base_url();?>admin/warehouse/create" class="btn sbold btn-primary"><i class="fa fa-plus"></i> Add warehouse
...
var table;
 ...
 $(document).ready(function() {
	 ...
	 table = $('#buku').DataTable({ 
		 ...
		 "ajax": {
			 "url": "<?php echo site_url('admin/warehouse/ajax_list')?>",
			 "type": "POST"
		 },
