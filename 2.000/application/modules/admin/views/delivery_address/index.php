				...
				<div class="portlet light bordered">
					<div class="portlet-title">
						<div class="caption font-dark">
							...
							<span class="caption-subject bold uppercase">Delivery address</span>
						</div>
						<div class="tools">
						<div class="btn-group">
      ...
      <div class="modal-body">
        <form action="javascript:void(0)" id="form_data" method="POST">
          <div class="form-group">
            ...
            <input type="hidden" name="delivery_address_id" class="form-control" >
...
var table;
 $(document).ready(function() {
	 table = $('#data_table').DataTable({ 
		 ...
		 "order": [], 
		 "ajax": {
			 "url": "<?php echo site_url('admin/delivery_address/ajax_list')?>",
			 "type": "POST"
		 },
		 "columnDefs": [
		 { 
...
function add_data()
{
	...
	$('#form_data').on('submit',function(){
        ...
        var user = $("[name='delivery_address_id']").val();
        if(user == ""){
           
                $.ajax({
                    url:"<?= base_url('admin/delivery_address/save_data');?>",
                    type:"POST",
 ...
 function hapus(no) {
  ...
  confirmButtonText: 'Yes, delete it!',
      ...
      function edit_data(id){
        ...
        $.ajax({
          url:"<?= base_url('admin/delivery_address/get_data/'); ?>"+id,
          type:"POST",
          dataType:"json",
          beforeSend:function(){
          ...
          success:function(data){
            $("[name='delivery_address_id']").val(data.delivery_address_id);
