				...
				<div class="portlet light bordered">
					<div class="portlet-title">
						<div class="caption font-dark">
							...
							<span class="caption-subject bold uppercase">Sea Air  </span>
						</div>
						<div class="tools">
						<div class="btn-group"> 
						<?php
							...
							if($type == 'shiper'){ ?>
							<a href="<?php echo base_url();?>admin/sea_air_service/form_sea_air" class="btn sbold btn-primary"><i class="fa fa-plus"></i> Add sea air
								</a>
...
var table;
 ...
 $(document).ready(function() {
	 ...
	 //datatables
	 table = $('#table_mastsser').DataTable({ 
