                        ...
                        <div class="col-md-12">
                            <div class="portlet light bordered">
                                ...
                                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" >
                                    ...
                                    ?>
                                    <input type="hidden" class="form-control" name="officer_id" id="officer_id" value="<?php echo $officer_id; ?>" />
                                    <div class="row">
                                        <div class="col-md-">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input">
                                                    <label class="col-md-4 control-label" for="nama_siswa">Warehouse</label>
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="warehouse_id" id="warehouse_id" required="true" <?php echo $read_only?>>
                                                            <option value="">-<?php echo $this->lang->line('selection'); ?>-</option>
                                                            <?php
                                                                $get_warehouse = $this->db->query("select warehouse_id, name from warehouse")->result();
                                                                foreach ($get_warehouse as $cl) {
                                                            ?>
                                                            <option <?php echo $warehouse_id== $cl->warehouse_id ? 'selected="selected"' : '' ?> value="<?php echo $cl->warehouse_id  ?>"><?php echo $cl->name  ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                        </select>
                                                        <div class="form-control-focus"></div><?php echo form_error('warehouse_id') ?>
                                                    </div>
                                                </div>
                                                <div class="form-group form-md-line-input">
                                                    <label class="col-md-4 control-label" for="nama_siswa">First Name</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" name="firstname" id="firstname" value="<?php echo $firstname; ?>" <?php echo $read_only?>/>
                                                        <div class="form-control-focus"></div><?php echo form_error('firstname') ?>
                                                    </div>
                                                </div>
                                                <div class="form-group form-md-line-input">
                                                    <label class="col-md-4 control-label" for="nama_siswa">Last Name</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" name="lastname" id="lastname" value="<?php echo $lastname; ?>" <?php echo $read_only?>/>
                                                        <div class="form-control-focus"></div><?php echo form_error('lastname') ?>
                                                    </div>
                                                </div>
                                                <div class="form-group form-md-line-input">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="prop" id="prop" onchange="ajaxkota(this.value)" required="true" <?php echo $read_only?>>
                                                            ...
                                                            ?>
                                                            <option <?php echo $officer_province_id== $cl->province_id ? 'selected="selected"' : '' ?> value="<?php echo $cl->province_id  ?>"><?php echo $cl->name  ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                        </select>
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="kota" id="kota" required="true" onchange="ajaxkec(this.value)" <?php echo $read_only?>>
                                                            <?php
                                                                if($officer_city_id != NULL){
                                                                    $city = $this->db->query("select name from city where city_id = '" . $officer_city_id . "'")->row();

                                                            ?>
                                                                <option value="<?php echo $officer_city_id?>"><?php echo $city->name?></option>
                                                            <?php
                                                                }else{
                                                            ?>
                                                                <option value="">-<?php echo $this->lang->line('selection'); ?>-</option>
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="kec" id="kec" class="form-control" onchange="ajaxkel(this.value)" <?php echo $read_only?>>
                                                            <?php
                                                                if($officer_district_id != NULL){
                                                                    $district = $this->db->query("select name from district where district_id = '" . $officer_district_id . "'")->row();

                                                            ?>
                                                                <option value="<?php echo $officer_district_id?>"><?php echo $district->name?></option>
                                                            <?php
                                                                }else{
                                                            ?>
                                                                <option value="">-<?php echo $this->lang->line('selection'); ?>-</option>
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8 ">
                                                        ...
                                                        <?php
                                                                if($officer_village_id != NULL){
                                                                    $village = $this->db->query("select name from village where village_id = '" . $officer_village_id . "'")->row();

                                                            ?>
                                                                <option value="<?php echo $officer_village_id?>"><?php echo $village->name?></option>
                                                            <?php
                                                                }else{
                                                            ?>
                                                                <option value="">-<?php echo $this->lang->line('selection'); ?>-</option>
