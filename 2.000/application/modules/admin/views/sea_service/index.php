				...
				<div class="portlet light bordered">
					<div class="portlet-title">
						<div class="caption font-dark">
							...
							<span class="caption-subject bold uppercase">Sea Service </span>
						</div>
						<div class="tools">
						<div class="btn-group">
						<?php
							...
							if($type == 'shiper'){ ?>
							<a href="<?php echo base_url();?>admin/sea_service/form_sea" class="btn sbold btn-primary"><i class="fa fa-plus"></i> Add Sea Service
								</a>
					...
					<div class="portlet-body">
						<table class="table table-xs table-bordered table-hover  display compact nowrap custom topcustom" cellspacing="0" cellpadding="0" id="tbl_sea">
							<thead >
								<tr  >
									<th width="5px">No</th>
									<th>Action</th>
