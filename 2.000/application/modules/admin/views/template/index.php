...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url();?>assets/pages/css/normal.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url();?>assets/pages/css/binForm.css" rel="stylesheet" type="text/css" />
...
<?php } ?>
  ...
  <script type="text/javascript">
        ...
        function updateNotif(id){
            $.ajax({
                url:"<?= base_url('admin/content/updateNotif');?>",
                type:"POST",
                data:{"id":id},
