                                        ...
                                        <div class="col-md-">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="hidden" class="form-control" name="code_main_city_old" id="code_main_city_old" value="<?php echo $code_main_city; ?>" />
                                                        <input type="text" class="form-control" name="code_main_city" id="code_main_city" value="<?php echo $code_main_city; ?>" />
                                                        <div class="form-control-focus"></div><?php echo form_error('code_main_city') ?>
                                                    </div>
                                                </div>
                                                <div class="form-group form-md-line-input">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="prop" id="prop"  required="true" <?php echo $read_only?>>
                                                            ...
                                                            ?>
                                                            <option <?php echo $main_city_province_id== $cl->province_id ? 'selected="selected"' : '' ?> value="<?php echo $cl->province_id  ?>"><?php echo $cl->name  ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                        </select>
