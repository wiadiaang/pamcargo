          ...
          <div class="left_col scroll-view">
            ...
            <div class="menu_section">
                ...
                ?>
                    ...
                    <li><a href="<?= base_url()?>admin/user"><i class="fa fa-user"></i> User </a>
                  ...
                  <?php }else if($type == 'news'){ ?>
                    <!-- <li id="menu_user"><a href="<?= base_url()?>admin/user"><i class="fa fa-user"></i>User</a></li> -->
                    <li><a href="<?= base_url()?>admin/news"><i class="fa fa-book"></i> News </a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?= base_url('assets')?>/images/img.jpg" alt=""><?= $this->session->userdata('email');?>
