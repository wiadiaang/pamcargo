                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="service_thumb"  style="justify-content: center; display: flex;">
                                        <img class="img-fluid" src="<?= base_url('assets/images/warehouse.jpg')?>"  style="width:70%; height:400px"   alt="">
                                    </div>
        ...
        <div class="container services-body">
            <div class="row">
                <div class="col-lg-12 offset-lg-1 services-content">
                    <h1 style="font-size: 25px;"><br>We offer below warehousing services.<br><br></h1>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col" style="padding: 10px;"><img class="img-thumbnail img-fluid"
                        src="assets/img/warehousing.png" style="width: 100%;height: 100%;"></div>
            </div>
        </div>
    </section> -->
