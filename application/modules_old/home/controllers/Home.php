...
class Home extends MX_Controller {
	...
	public function index()
	{
		...
		$a['slider'] = $this->db->query("SELECT * FROM pam_slider order by slider_id desc")->result(); 
	...
	public function schedule_query_result(){
		...
		$a['schedule'] = $this->db->query("SELECT * FROM schedule WHERE departure_id = $departure_id AND
		transit_time !='' ")->result_array();
	...
	public function news(){
		$a['data'] = $this->db->query("SELECT * FROM pam_news order by news_id DESC")->result(); 
