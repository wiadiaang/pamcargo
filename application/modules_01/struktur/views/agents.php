                    ...
                    <div class="content-box">
                        <div class="mini-content">
                            <div class="col text-center">
                                <h5 style="font-size: 20px;"><strong>AIF TAIPEI</strong><br></h5>
                            </div>
                        </div>
                        <div class="card alucard" style="padding-top: 20px;padding-left: 15px;padding-right: 10px;">
                            <h1 class="text-center" style="font-size: 22px;padding-right: 5px;padding-left: 5px;padding-top: 5px;"><strong>Business Development Manager</strong><br></h1>
                            <p><br>Air International Freight Co., Ltd.&nbsp;<br>AIF Global Logistics Co., Ltd.&nbsp;<br>Taiwan. Hong Kong. China.11F, No. 46, Sec. 5, Nanking E.Rd., Taipei 10597, Taiwan, R.O.C. | (105)<br></p>
                            <h1 class="text-center" style="font-size: 22px;padding-right: 5px;padding-left: 5px;padding-top: 5px;"><strong>Contact: Ms. LINDA JAN</strong><br></h1>
                            <p><br>Tel : +886 (02) 27641022 #286&nbsp;<br>Mobile : +886-9177-91603&nbsp;<br>Email : linda.jan@aif.com.tw<br></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-4">
