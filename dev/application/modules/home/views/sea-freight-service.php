<?php $this->load->view('struktur/header');?>
    ...
    <div class="bradcam_area" style="background-image:url(./assets/v.2/img/header-pamcargo/sea-freight.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12"> 
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="service_thumb" style="justify-content: center; display: flex;">
                                        <img class="img-fluid" src="https://www.pamcargo.com/pamcargo_old/files/services/sea_freight_services_945124772.jpg" style="width:70%; height:400px"  alt="">
                                    </div>
