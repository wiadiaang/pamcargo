                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="service_thumb" style="justify-content: center; display: flex;">
                                        <img class="img-fluid" src="https://www.pamcargo.com/pamcargo_old/files/services/ad_hoc_charter_service_582730809.jpg" style="width:70%; height:350px"  alt="">
                                    </div>
    ...
    <section class="services-body">
        <div class="container services-body">
            ...
            <div class="row">
                ...
                <div class="col" style="padding: 10px;"><img class="img-thumbnail img-fluid" src="assets/img/ad-hoc.png" style="width: 100%;height: 100%;"></div>
            </div>
        </div>
    </section> -->
