                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="service_thumb " style="justify-content: center; display: flex;">
                                        <img class="img-fluid" src="<?= base_url('assets/v.2/img/header-pamcargo/sea-air-service-1.jpg') ?>"  style="" alt="">
                                        <!-- <img class="img-fluid" src="<?= base_url('assets/v.2/img/header-pamcargo/sea-air-service-1.jpg') ?>"  style="width:70%; height:300px" alt=""> -->
                                    </div>
    ...
    <section class="services-body">
        <div class="container services-body">
            ...
            <div class="row">
                ...
                <div class="col" style="padding: 10px;"><img class="img-thumbnail img-fluid" src="assets/img/img-header.png" style="width: 100%;height: 50%;"></div>
            </div>
