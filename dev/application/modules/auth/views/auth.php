...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="<?= base_url();?>assets/dash/vendors/animate.css/animate.min.css" rel="stylesheet">
          ...
          <section class="login_content">
            <form action="<?= base_url('auth/login'); ?>" method="POST">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class=""></i>PAM CARGO</h1>
                  <p>©2021 All Rights Reserved. Pam Cargo Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
