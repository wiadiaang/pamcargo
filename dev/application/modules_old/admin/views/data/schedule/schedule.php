     ...
     <div class="x_panel">
       <div class="x_title">
        ...
        <div class="x_content">  
                ...
                <form id="form_upload" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="">Departure</label>
                        <select name="departure_id" id="departure_id" class="form-control">
                           <option value="">-- Select Departure --</option>
                           <?php 
                              $a = $this->db->query("SELECT * FROM departure WHERE active != '0' ")->result();
                              foreach($a as $b){
                           ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class=""  name="image" id="userfile" >
